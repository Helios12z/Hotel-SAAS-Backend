...
| Screen | Route | Mô t? |
|--------|-------|-------|
| Rooms List | `/manage/hotels/[id]/rooms` | Danh sách phòng |
| Room Detail | `/manage/hotels/[id]/rooms/[roomId]` | Chi ti?t & ch?nh s?a |
| Add Room | `/manage/hotels/[id]/rooms/new` | Thêm phòng m?i |
| Bulk Add | `/manage/hotels/[id]/rooms/bulk-add` | Thêm nhi?u phòng |
| Pricing | `/manage/hotels/[id]/rooms/[roomId]/pricing` | Qu?n lý giá |
